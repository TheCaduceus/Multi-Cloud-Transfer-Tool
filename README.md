...
<h4><b>3.Ability to pack or extract of Files or Folder in varity of formats with or without Password Protection while moving the data from One Cloud to another Cloud.</b></h4>
<h4><b>4.Various amazing Add-ons which will make your task or work more simple. It combines the power of Rclone with other engines which make a combination that can do your work by taking less efforts and giving more output.</b></h4>
<h2><b>📑 INDEX</b></h2>
...
<p><b><a href="https://github.com/TheCaduceus/Multi-Cloud-Transfer-Tool#supported-command-list">🗃️Supported Command List</a></b></p>
...
<h4><b>3.To Create/Edit/Delete/View comfig file/remote just run the code as shown in the Image. You can also save your Rclone config file for using it in future without doing same thing repeatedly.</b></h4>
...
<h4><b>The service accounts can be used to bypass the 750Gb/day upload limit set by google in Google Drive. It means that you can use them to upload more than 750Gb per day, duplicate hundreds of files...Each service account has a 750Gb upload limit per day. You can create up to 100 service account per google cloud project. So, with only one project you can upload/duplicate up to 75Tb a day!</b></h4>
  ...
  <h4><b>This project comes with various amazing Add-ons which will make your task or work more simple. It combines the power of Rclone with other engines which make a combination that can do your work by taking less efforts and giving more output.</b></h4>
  ...
  <h4><b>2.Now Get the both Source Path & Destination Path, Refer to STEP 3 of "🪝Multi Cloud Transfer" section to learn how to get both Path.</b></h4>
